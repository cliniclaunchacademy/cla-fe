  ...
  return (
    <section className="w-full px-4 fixed top-4 left-0 z-50">
      <div className="w-full h-[62px] px-6 bg-[#02070A] rounded-[30px] flex items-center justify-between">
        ...
        <Link href="/login" className="hidden md:block px-4 py-2 border border-[#45A08B] rounded-[10px] text-[#45A08B] textBody16 hover:bg-[#45A08B33] transition duration-200">
          Admin Login
        </Link>
      </div>
      ...
      {isMobileOpen && (
        <div className="md:hidden mt-1 bg-[#02070A] rounded-[20px] py-6 text-white">
          <div className="max-h-[75vh] px-6 space-y-3 overflow-y-auto scrollbar-thin">
            ...
            <Link href="/login" className="block text-center w-full mt-4 px-4 py-2 border border-[#45A08B] rounded-[10px] text-[#45A08B] textBody16 hover:bg-[#45A08B33] transition duration-200">
              Admin Login
            </Link>
          </div>
        </div>
