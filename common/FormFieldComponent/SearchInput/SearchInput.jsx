...
const SearchInput = ({
  ...
  return (
    <div className="w-full h-[40px] max-w-[464px] flex items-center justify-center rounded-[10px] bg-[#FAFAFA] border-[2px] border-[#C4C4C4] focus-within:border-[#663F7E] transition duration-100 px-3 ">
      <button
        type="button"
        onClick={onSubmit}
        className=""
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full h-full ps-3 redhat text-[#9C9C9C] focus:text-[#484848] textBody16 outline-none rounded-full bg-transparent"
      />
