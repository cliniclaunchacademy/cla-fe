                ...
                {editingName ? (
                  <div className="flex items-center gap-2">
                    ...
                    <input value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Last name"
                      className="bg-[#17191B] border border-[#484942] text-[#DFE1E3] textBody14 rounded-[8px] px-3 py-1.5 w-[120px] focus:outline-none focus:border-[#B88934] transition" />
                    <button onClick={() => saveProfile({ firstName, lastName })} disabled={isSavingProfile}
                    ...
                    <button onClick={() => { setFirstName(user?.firstName || ""); setLastName(user?.lastName || ""); setEditingName(false); }} disabled={isSavingProfile}
              ...
              <SettingRow label="Username">
                {editingUsername ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => saveUsername(username)} disabled={isSavingUsername}
                      className="textLabel14 bg-[#B88934] hover:bg-[#DFAF32] text-[#2C2313] rounded-[8px] px-4 py-1.5 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                      {isSavingUsername ? "Saving..." : "Save"}
                    </button>
                    <button onClick={() => { setUsername(user?.username || ""); setEditingUsername(false); }} disabled={isSavingUsername}
                      className="textLabel14 text-[#ABADAF] hover:text-[#DFE1E3] transition duration-200">
                      Cancel
                    </button>
                  </div>
