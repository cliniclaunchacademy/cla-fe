...
import { getAdminDashboardStats, getRecentlyJoined, getNotificationHistory } from "apis/admin-dashboard.api";
  ...
  return (
    <section className="w-full flex flex-col gap-y-9 px-9 py-10">
        ...
        <div>
          <Accordion type="single" collapsible defaultValue="signup-trends" className="w-full bg-[#181818] border-2 border-[#2E2D26] rounded-[16px] p-8">
            <AccordionItem value="signup-trends">
              ...
              <AccordionContent>
                <p className="text-[#ABADAF] textBody16 mb-6">New sign-ups over last 7 days</p>
                {recentLoading ? <Loader isLoading={true} /> : recentUsers.length === 0 ? (
      ...
      <div>
        ...
        <div>
          <Accordion type="single" collapsible defaultValue="dropoff" className="w-full bg-[#181818] border-2 border-[#2E2D26] rounded-[16px] p-8">
            <AccordionItem value="dropoff">
              <AccordionTrigger>
                <div className="flex items-center gap-3">
                  <div className="w-fit h-[21px] border-2 border-[#B88934] rounded-[1px]"></div>
