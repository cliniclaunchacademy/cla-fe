...
import courseVideoImg from "@assets/images/courseVideoImg.png";
...
export default function CourseVideoPlayer() {
  ...
  return (
    <section className="px-9 py-10  ">
      <Link href="" className="w-fit py-2.5 px-[14px] flex gap-2 items-center textLabel16 text-[#DFE1E3] rounded-[8px] bg-transparent hover:bg-[#313335] active:bg-transparent transition duration-300 mb-7 ">
        <span>
      ...
      <div className="flex flex-col lg:flex-row gap-[30px] ">
        <div className="w-full lg:w-8/12 ">
          <div style={{ padding: "50% 0 0 0", position: "relative" }}>
            <iframe
              src="https://player.vimeo.com/video/1178213285?badge=0&autopause=0&player_id=0&app_id=58479"
              frameBorder="0"
          ...
          <div className="flex flex-col 2xl:flex-row gap-8 justify-between items-start mt-7 mb-[21px]">
            <div className="w-full 2xl:w-6/12 ">
              <h3 className="textDisplay36 text-[#FFFFFF] ">
                The Dawn of the Facilitation
                Economy: Your Untapped
                Opportunity
              </h3>
            </div>

            <div className="flex gap-2.5 items-center justify-center flex-wrap">
              <button className="px-[14px] py-2.5 flex gap-2 items-center bg-[#271C13] hover:bg-[#313335] active:bg-transparent rounded-[8px] border-2 border-[#50392A] text-[#FFEEEF] textLabel16 transition duration-200 ">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_171_3248)">
                    <path d="M7.71625 0.848019C9.58029 0.554348 11.4885 0.909111 13.123 1.85217C13.4817 2.05912 13.6051 2.51736 13.3984 2.8761C13.1914 3.23487 12.7325 3.35776 12.3737 3.15075C11.0365 2.3792 9.47495 2.08949 7.94989 2.32971C6.4248 2.56998 5.0279 3.32597 3.99262 4.47131C2.95735 5.6167 2.34588 7.08259 2.26044 8.62414C2.17502 10.1657 2.62072 11.6904 3.52313 12.9432C4.42555 14.1959 5.73046 15.1016 7.21967 15.5089C8.70887 15.9161 10.2929 15.8006 11.7072 15.1815C13.1216 14.5624 14.2811 13.4766 14.9921 12.1061C15.7031 10.7356 15.9222 9.16282 15.614 7.65002C15.5313 7.24424 15.7934 6.84807 16.1992 6.76526C16.605 6.68256 17.0012 6.94462 17.0839 7.35046C17.4607 9.19952 17.192 11.1217 16.3229 12.7967C15.4539 14.4718 14.0372 15.7988 12.3085 16.5555C10.58 17.3122 8.64424 17.4531 6.82416 16.9554C5.00397 16.4576 3.4088 15.3511 2.30585 13.8199C1.20291 12.2888 0.658265 10.4255 0.762636 8.54138C0.867033 6.6572 1.61471 4.86565 2.88007 3.46569C4.14541 2.06582 5.85224 1.14169 7.71625 0.848019ZM15.9684 2.4696C16.2614 2.17704 16.7362 2.17685 17.029 2.4696C17.3219 2.76249 17.3219 3.23799 17.029 3.53088L9.52899 11.0309C9.23621 11.3236 8.76135 11.3234 8.46845 11.0309L6.21845 8.78088C5.92555 8.48799 5.92555 8.01249 6.21845 7.7196C6.51135 7.42704 6.98621 7.42685 7.27899 7.7196L8.99872 9.43933L15.9684 2.4696Z" fill="#FFEEEF" />
                  </g>
                  <defs>
                    <clipPath id="clip0_171_3248">
              ...
              <button className="px-[14px] py-2.5 flex gap-2 items-center bg-transparent hover:bg-[#313335] active:bg-transparent rounded-[8px] border-2 border-[#ABADAF] text-[#DFE1E3] textLabel16 transition duration-200 ">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3 3V8.25H6.75V3H3ZM8.25 8.25C8.25 9.07843 7.57843 9.75 6.75 9.75H3C2.17157 9.75 1.5 9.07843 1.5 8.25V3C1.5 2.17157 2.17157 1.5 3 1.5H6.75C7.57843 1.5 8.25 2.17157 8.25 3V8.25Z" fill="#DFE1E3" />
                  <path d="M11.25 3V5.25H15V3H11.25ZM16.5 5.25C16.5 6.07843 15.8284 6.75 15 6.75H11.25C10.4216 6.75 9.75 6.07843 9.75 5.25V3C9.75 2.17157 10.4216 1.5 11.25 1.5H15C15.8284 1.5 16.5 2.17157 16.5 3V5.25Z" fill="#DFE1E3" />
                  <path d="M11.25 9.75V15H15V9.75H11.25ZM16.5 15C16.5 15.8284 15.8284 16.5 15 16.5H11.25C10.4216 16.5 9.75 15.8284 9.75 15V9.75C9.75 8.92157 10.4216 8.25 11.25 8.25H15C15.8284 8.25 16.5 8.92157 16.5 9.75V15Z" fill="#DFE1E3" />
                  <path d="M3 12.75V15H6.75V12.75H3ZM8.25 15C8.25 15.8284 7.57843 16.5 6.75 16.5H3C2.17157 16.5 1.5 15.8284 1.5 15V12.75C1.5 11.9216 2.17157 11.25 3 11.25H6.75C7.57843 11.25 8.25 11.9216 8.25 12.75V15Z" fill="#DFE1E3" />
                </svg>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 ">
                <button className="bg-[#1C1E20] active:bg-gradient-to-b focus:bg-gradient-to-b from-[rgba(170,124,48,0.3)] to-[rgba(170,124,48,0.15)] p-5 border-2 border-[#313335] rounded-[16px] flex gap-4 items-center text-start">
                  ...
                  <div>
                    <p className="text-[#FFFFFF] textLabel16 ">The Dawn of the Facilitation Econ...</p>
                    <p className="text-[#ABADAF] textBody14 !font-semibold ">10 min</p>
                  </div>
                </button>
                <button className="bg-[#1C1E20] active:bg-gradient-to-b focus:bg-gradient-to-b from-[rgba(170,124,48,0.3)] to-[rgba(170,124,48,0.15)] p-5 border-2 border-[#313335] rounded-[16px] flex gap-4 items-center text-start">
                  <div className="relative w-[112px] h-[74px] bg-[#37352B] rounded-[12px] flex items-center justify-center ">
