    ...
    <section className="w-full flex flex-col gap-y-10 px-9 py-10 ">
      ...
      lg:[grid-template-columns:repeat(4,minmax(0,324px))]">
        <div className="w-full max-w-[324px] border-2 border-[#26282A] rounded-[16px] bg-[#1C1E20] p-[18px] flex lg:flex-col 2xl:flex-row gap-5 justify-between items-start ">
          <div className="flex flex-col gap-1 ">
            ...
            <p className="text-[#EFEFEE] textHeading28 !font-bold ">8</p>
            <p className="text-[#ABADAF] textHeading16 ">of 10 available</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[43px] ">
        ...
        <div>
          ...
          <div className="border-2 border-[#26282A] rounded-[16px] py-3 px-5 bg-[#1C1E20] flex gap-4 justify-between items-start ">
            <div className="text-[#DFE1E3]">
              <p className=" textBody18 !font-semibold mb-2 ">CEO Mindset & Discipline Protocol</p>
              <p className="textBody16 ">1 of 7 lessons completed</p>
            </div>
      ...
      <div>
        ...
        <div className="border border-[#313335] rounded-[14px] bg-[#1C1E20] ">
          {/* card */}
          <div className="px-5 py-[17.5px] flex justify-between items-center gap-3 flex-wrap ">
            <div className="flex gap-5 items-center ">
              <div className="w-[42px] h-[42px] rounded-[10px] bg-[#232420] flex items-center justify-center text-[#AE9060] ">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_139_1017)">
              ...
              <div>
                <p className="text-[#EFEFEE] textBody18 !font-semibold mb-0.5 ">Meta Technicals</p>
                <p className="text-[#ABADAF] ">Clinic Magnet Paid Ads Engine•Tracking, CRM Integration & Technical Setup </p>
              </div>
            </div>
            <div>
              <p className="text-[#ABADAF] ">0m watched</p>
            </div>
          </div>
          {/* card */}
          <div className="px-5 py-[17.5px] flex justify-between items-center gap-3 flex-wrap ">
